...
We also provide the piece of code (under API_Sonia_future_price_data.py) used to reconstruct the chart of future implied rates, illustrating the extent to which the MPC’s potential rate hikes or cuts are currently priced in.
